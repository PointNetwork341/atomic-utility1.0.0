...
execute @s[tag=stafftag,scores={KPM=1}] ~~~ execute @s[scores={fmmtoggle=0,ammtoggle=0}] ~~~ tellraw @a[tag=stafftag] {"rawtext":[{"text":"§¶§cAtomic Utility §¶§b⤤ §6KitPvP Mode §bhas been toggled §2ON §bby §d"},{"selector":"@s"}]}
#turn off
...
execute @s[tag=stafftag,scores={KPM=2}] ~~~ tellraw @a[tag=stafftag] {"rawtext":[{"text":"§¶§cAtomic Utility §¶§b⤤ §6KitPvP Mode §bhas been toggled §cOFF §bby §d"},{"selector":"@s"}]}
