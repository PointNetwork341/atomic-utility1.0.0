...
execute @s[tag=ownertag,scores={lockdown=1}] ~~~ tellraw @a[tag=ownertag] {"rawtext":[{"text":"§¶§cAtomic Utility §¶§b⤤ §6REALM/SERVER §bhas been §2LOCKED DOWN §bby §d"},{"selector":"@s"}]}
...
execute @s[tag=ownertag,scores={lockdown=2}] ~~~ tellraw @a[tag=ownertag] {"rawtext":[{"text":"§¶§cAtomic Utility §¶§b⤤ §6REALM/SERVER §bhas been §cUNLOCKED §bby §d"},{"selector":"@s"}]}
execute @s[tag=ownertag,scores={lockdown=2}] ~~~ scoreboard players set lockdowntoggledummy lockdown 0

execute @s[tag=!ownertag] ~~~ tellraw @s {"rawtext":[{"text":"§¶§cAtomic Utility §¶§b⤤ You must be owner to use this command!"}]}
