...
execute @s[tag=!stafftag] ~~~ title @s[tag=BanCreative] title §¶§cAtomic Utility §b➢ §cBanned §f| §cCreative Mode
execute @s[scores={acmtoggle=1}] ~~~ execute @s[tag=!stafftag] ~~~ title @s[tag=BanCBE] title §¶§cAtomic Utility §b➢ §cBanned §f| §cCBE
execute @s[tag=!stafftag] ~~~ title @s[tag=Ban] title §¶§cAtomic Utility §b➢ §cBanned | Manually
execute @s[scores={IIM=1}] ~~~ execute @s[tag=!stafftag] ~~~ title @s[tag=illegalitemban] title §¶§cAtomic Utility §b➢ §cBanned §f| §cIllegals
execute @s[scores={afmtoggle=1}] ~~~ execute @s[tag=!stafftag] ~~~ title @s[tag=BanFly] title §¶§cAtomic Utility §b➢ §cBanned §f| §cFly Hacks
execute @s[scores={apmtoggle=1}] ~~~ execute @s[tag=!stafftag] ~~~ title @s[tag=BanPhase] title §¶§cAtomic Utility §b➢ §cBanned §f| §cPhase
...
execute @s[scores={BanCBE=1}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAtomic Utility ➢ §d"},{"selector":"@s"},{"text":" §¶§cgot banned for CBE Exploits"}]}
...
execute @s[scores={IIB=1}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAtomic Utility ➢ §d"},{"selector":"@s"},{"text":" §¶§cgot banned for Illegal Items"}]}
execute @s[scores={BanFly=1}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAtomic Utility ➢ §d"},{"selector":"@s"},{"text":" §¶§cgot banned for Fly Hacks"}]}
execute @s[scores={BanPhase=1}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAtomic Utility ➢ §d"},{"selector":"@s"},{"text":" §¶§cgot banned for Phase."}]}
