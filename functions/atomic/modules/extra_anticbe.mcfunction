#stops cbe for Owner
execute @r[tag=Owner,tag=!ownertag] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAtomic Utility ➢ §¶§cFlagged §d"},{"selector":"@s"},{"text":"§¶§c for trying to get owner tag"}]}
...
execute @r[tag=administrator,tag=!ownertag] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAtomic Utility ➢ §¶§cFlagged §d"},{"selector":"@s"},{"text":"§¶§c for trying to get staff tag"}]}
execute @a[tag=administrator,tag=!ownertag] ~~~ tag @s remove administrator

#stops cbe for op
execute @r[tag=op,tag=!ownertag] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAtomic Utility ➢ §¶§cFlagged §d"},{"selector":"@s"},{"text":"§¶§c for trying to get owner tag"}]}
execute @a[tag=op,tag=!ownertag] ~~~ tag @s remove op

#stops cbe for ownerstatus
execute @r[tag=ownerstatus,tag=!ownertag] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAtomic Utility ➢ §¶§cFlagged §d"},{"selector":"@s"},{"text":"§¶§c for trying to get owner tag"}]}
