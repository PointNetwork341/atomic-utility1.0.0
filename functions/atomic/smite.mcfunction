...
execute @s[tag=stafftag] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAtomic Utility ⤤ §bUnable to use smite on §d"},{"selector":"@s"},{"text":" §¶§bbecause they are staff."}]}

#Smite players
execute @s[tag=!stafftag] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAtomic Utility ⤤ §d"},{"selector":"@s"},{"text":" §¶§bwas smited by a operator"}]}
