...
execute @s[tag=stafftag,scores={dethtoggle=1}] ~~~ tellraw @a[tag=stafftag] {"rawtext":[{"text":"§¶§cAtomic Utility §¶§b➢ §6Death Effect §bhas been toggled §2ON §bby §d"},{"selector":"@s"}]}
#turn off
...
execute @s[tag=stafftag,scores={dethtoggle=2}] ~~~ tellraw @a[tag=stafftag] {"rawtext":[{"text":"§¶§cAtomic Utility §¶§b➢ §6Death Effect §bhas been toggled §cOFF §bby §d"},{"selector":"@s"}]}
