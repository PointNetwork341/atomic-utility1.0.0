...
#Global Bans
#execute @r[tag=PermBan] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAtomic Utility ➢ §d"},{"selector":"@s"},{"text":" §¶§cis Atomic Global Banned"}]}
#kick @r[tag=PermBan] §¶§cAtomic Utility ➢ You are Atomic Global Banned! You may not join realms protected by Atomic.

#Autoban Creative/CBE
execute @a[m=c,tag=!stafftag] ~~~ function atomic/asset/creative_flag_asset

#Kick Messages
#execute @a[tag=BanCBE] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAtomic Utility ➢ §d"},{"selector":"@s"},{"text":" §¶§cwas season banned for CBE exploits"}]}
#execute @a[scores={warn=3}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAtomic Utility ➢ §d"},{"selector":"@s"},{"text":" §¶§cwas season banned for reaching 3 warnings"}]}
#execute @a[tag=illegalitemban] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAtomic Utility ➢ §d"},{"selector":"@s"},{"text":" §¶§cwas season banned for illegal items"}]}
...
#kick @a[scores={warn=3}] §¶§cAtomic Utility ➢ Season Banned - 3 Warnings Recieved
#kick @a[tag=illegalitemban] §¶§cAtomic Utility ➢ Season Banned - Illegal Items
#kick @a[tag=BanCBE] §¶§cAtomic Utility ➢ Season Banned - CBE
#kick @a[tag=BanBypass] §¶§cAtomic Utility ➢ Season Banned - Attempting Bypass
#kick @a[tag=Ban] §¶§cAtomic Utility ➢ Season Banned - Banned By Operator
