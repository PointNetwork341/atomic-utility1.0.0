...
execute @s[scores={mdmtoggle=1}] ~~~ execute @s[tag=stafftag] ~~~ tellraw @a[tag=stafftag] {"rawtext":[{"text":"§¶§cAtomic Utility §¶§b⤤ §6Lapis Alerts §bhas been toggled §2ON §bby §d"},{"selector":"@s"}]}
