execute @s[scores={ammtoggle=0,kpmtoggle=0}] ~~~ tellraw @s {"rawtext":[{"text":"§¶§cAtomic Utility ➢ §¶§bSpawn Point has been set for §d"},{"selector":"@s"}]}
...
execute @s[scores={ammtoggle=0,kpmtoggle=0}] ~~~ tellraw @s {"rawtext":[{"text":"§¶§cAtomic Utility ➢ §¶§bSpawn Set To§g X: "},{"score":{"name":"@s","objective":"X_Coordinate"}},{"text":" Y: "},{"score":{"name":"@s","objective":"Y_Coordinate"}},{"text":" Z: "},{"score":{"name":"@s","objective":"Z_Coordinate"}}]}
