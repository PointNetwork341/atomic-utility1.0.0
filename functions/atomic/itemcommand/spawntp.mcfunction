...
execute @s[scores={ammtoggle=0}] ~~~ tellraw @s {"rawtext":[{"text":"§¶§cAtomic Utility §b⤤ Teleporting §d"},{"selector":"@s"},{"text":" §¶§bto World Spawn §230 §bseconds. Make sure to stay still."}]}
