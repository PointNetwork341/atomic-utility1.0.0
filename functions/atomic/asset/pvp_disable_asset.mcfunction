#If player is staff
execute @s[tag=stafftag] ~~~ tellraw @a[tag=stafftag] {"rawtext":[{"text":"§¶§cAtomic Utility ➢ §d"},{"selector":"@s"},{"text":" §¶§bis staff, their pvp can't be disabled."}]}
...
execute @s[tag=!stafftag,scores={pvpdis=1}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAtomic Utility ➢ §d"},{"selector":"@s"},{"text":" §¶§bhas gotten their §6pvp disabled §bby a operator."}]}
...
execute @s[tag=!stafftag,scores={pvpdis=2}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAtomic Utility ➢ §d"},{"selector":"@s"},{"text":" §¶§bhas gotten their §6pvp enabled §bby a operator."}]}
