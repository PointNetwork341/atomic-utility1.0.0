...
execute @s[tag=stafftag,scores={unban=1}] ~~~ tellraw @a[tag=stafftag] {"rawtext":[{"text":"§¶§cAtomic Utility §¶§b➢ §d"},{"selector":"@s"},{"text":" §bhas §2OPENED a §6Unban Window"}]}
...
execute @s[tag=stafftag,scores={unban=2}] ~~~ tellraw @a[tag=stafftag] {"rawtext":[{"text":"§¶§cAtomic Utility §¶§b➢ §d"},{"selector":"@s"},{"text":" §bhas §cCLOSED a §6Unban Window"}]}
