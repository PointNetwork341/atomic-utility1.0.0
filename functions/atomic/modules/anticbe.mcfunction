...
execute @r[tag=staffstatus,tag=!stafftag] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAtomic Utility ➢ §¶§cFlagged §d"},{"selector":"@s"},{"text":"§¶§c for trying to get staff tag"}]}
execute @a[tag=staffstatus,tag=!stafftag] ~~~ tag @s remove staffstatus

#stops cbe for staff
execute @r[tag=staff,tag=!stafftag] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAtomic Utility ➢ §¶§cFlagged §d"},{"selector":"@s"},{"text":"§¶§c for trying to get staff tag"}]}
execute @a[tag=staff,tag=!stafftag] ~~~ tag @s remove staff

#stops cbe for admin
execute @r[tag=admin,tag=!stafftag] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAtomic Utility ➢ §¶§cFlagged §d"},{"selector":"@s"},{"text":"§¶§c for trying to get staff tag"}]}
execute @a[tag=admin,tag=!stafftag] ~~~ tag @s remove admin

#stops cbe for MOD
execute @r[tag=MOD,tag=!stafftag] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAtomic Utility ➢ §¶§cFlagged §d"},{"selector":"@s"},{"text":"§¶§c for trying to get staff tag"}]}
execute @a[tag=MOD,tag=!stafftag] ~~~ tag @s remove MOD

#stops cbe for Moderator
execute @r[tag=Moderator,tag=!stafftag] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAtomic Utility ➢ §¶§cFlagged §d"},{"selector":"@s"},{"text":"§¶§c for trying to get staff tag"}]}
