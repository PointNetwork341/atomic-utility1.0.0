#Fake staff flag
execute @s[scores={ssmtoggle=1}] ~~~ execute @s[scores={I2IO2NO=!273},tag=stafftag] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAtomic Utility ➢ §6Fake Staff Protection : §bFlagged §d"},{"selector":"@s"},{"text":"§¶§b for unauthorized staff tag."}]}
