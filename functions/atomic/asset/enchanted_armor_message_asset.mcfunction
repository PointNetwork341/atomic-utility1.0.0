...
execute @s[scores={damtoggle=1}] ~~~ execute @s[scores={headen=1}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAtomic Utility §b⤤ §6No Enchanted Armor §bremoved Enchanted Helmet from §d"},{"selector":"@s"}]}
...
execute @s[scores={damtoggle=1}] ~~~ execute @s[scores={chesten=1}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAtomic Utility §b⤤ §6No Enchanted Armor §bremoved Enchanted Chestplate from §d"},{"selector":"@s"}]}
...
execute @s[scores={damtoggle=1}] ~~~ execute @s[scores={legen=1}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAtomic Utility §b⤤ §6No Enchanted Armor §bremoved Enchanted Leggings from §d"},{"selector":"@s"}]}
...
execute @s[scores={damtoggle=1}] ~~~ execute @s[scores={feeten=1}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAtomic Utility §b⤤ §6No Enchanted Armor §bremoved Enchanted Boots from §d"},{"selector":"@s"}]}
