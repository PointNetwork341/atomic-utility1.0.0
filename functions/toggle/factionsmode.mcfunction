...
execute @s[tag=stafftag,scores={FMM=1}] ~~~ execute @s[scores={kpmtoggle=0,ammtoggle=0}] ~~~ tellraw @a[tag=stafftag] {"rawtext":[{"text":"§¶§cAtomic Utility §¶§b➢ §6Factions Mode §bhas been toggled §2ON §bby §d"},{"selector":"@s"}]}
#turn off
...
execute @s[tag=stafftag,scores={FMM=2}] ~~~ tellraw @a[tag=stafftag] {"rawtext":[{"text":"§¶§cAtomic Utility §¶§b➢ §6Factions Mode §bhas been toggled §cOFF §bby §d"},{"selector":"@s"}]}
