...
execute @s[tag=stafftag,scores={AMM=1}] ~~~ execute @s[scores={kpmtoggle=0,fmmtoggle=0}] ~~~ tellraw @a[tag=stafftag] {"rawtext":[{"text":"§¶§cAtomic Utility §¶§b➢ §6Anarchy Mode §bhas been toggled §2ON §bby §d"},{"selector":"@s"}]}
#turn off
...
execute @s[tag=stafftag,scores={AMM=2}] ~~~ tellraw @a[tag=stafftag] {"rawtext":[{"text":"§¶§cAtomic Utility §¶§b➢ §6Anarchy Mode §bhas been toggled §cOFF §bby §d"},{"selector":"@s"}]}
