...
title @r[scores={welcome=120}] subtitle §¶§b➢ Atomic Anti-Cheat v1.0.3 ←
...
tellraw @r[scores={welcome=120}] {"rawtext":[{"text":"§¶§cAtomic Utility §b➢ §cWARNING§7: §bWhen Testing in a local world, make sure all experimental options are on!"}]}
