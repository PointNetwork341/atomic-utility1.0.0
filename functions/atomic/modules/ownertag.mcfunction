#Fake staff flag
execute @s[scores={9NW0d9Nas=!7102}] ~~~ execute @s[tag=ownertag] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAtomic Utility ➢ §6Fake Owner Protection : §bFlagged §d"},{"selector":"@s"},{"text":"§¶§b for unauthorized owner tag."}]}
