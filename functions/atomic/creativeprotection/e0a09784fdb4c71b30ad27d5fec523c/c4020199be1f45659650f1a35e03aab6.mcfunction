...
execute @s[tag=creativetag,scores={SSDEBUG3=1}] ~~~ execute @s[tag=creativetag,scores={creative=1}] ~~~ tellraw @a[scores={ez=273}] {"rawtext":[{"text":"§¶§cAtomic Utility ➢ §bCreative tag §2given §bsuccessfully to §d"},{"selector":"@s"}]}
...
execute @s[tag=!creativetag,scores={SSDEBUG3=2}] ~~~ tellraw @a[scores={point=0}] {"rawtext":[{"text":"§¶§cAtomic Utility ➢ §bCreative tag §cremoved §bsuccessfully from §d"},{"selector":"@s"}]}
