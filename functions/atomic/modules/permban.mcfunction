...
tag "XdIapple" add PermBan
tag "xilshnagslix" add PermBan
tag "Slime King66" add PermBan
...
tag "LittleGman4156" add PermBan
tag "FartKnocker2017" add PermBan
...
tag "ClemboNacho" add PermBan
tag "Eeveetastic" add PermBan
tag "snipernation317" add PermBan
tag "springmusic3366" add PermBan
tag "day530" add PermBan
tag "removingbasil56" add PermBan
tag "not brisk1305" add PermBan
tag "dampmusician374" add PermBan
tag "alertedmango240" add PermBan
tag "starwarsrocks22" add PermBan
