...
execute @s[tag=stafftag,scores={SSDEBUG=1}] ~~~ execute @s[tag=stafftag,scores={staff=1}] ~~~ tellraw @a[scores={I2IO2NO=273}] {"rawtext":[{"text":"§¶§cAtomic Utility ➢ §bStaff tag §2given §bsuccessfully to §d"},{"selector":"@s"}]}
...
execute @s[tag=!stafftag,scores={SSDEBUG=2}] ~~~ tellraw @a[scores={2DI3N=0}] {"rawtext":[{"text":"§¶§cAtomic Utility ➢ §bStaff tag §cremoved §bsuccessfully from §d"},{"selector":"@s"}]}
