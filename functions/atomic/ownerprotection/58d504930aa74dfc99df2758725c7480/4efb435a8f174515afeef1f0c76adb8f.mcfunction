...
#deny messages
execute @s[scores={ssmtoggle=1,I2IO2NO=!273},tag=stafftag] ~~~ tellraw @s {"rawtext":[{"text":"§¶§cAtomic Utility §¶§b➢ Access §cDENIED§7! §bFake Staff Protection §2ENABLED. §bOwner must execute hidden stafftag key first."}]}
execute @s[tag=!stafftag] ~~~ tellraw @s {"rawtext":[{"text":"§¶§cAtomic Utility §¶§b➢ Access §cDENIED§7! §bOnly staff can use this command"}]}
execute @s[scores={ssmtoggle=1,I2IO2NO=273}] ~~~ tellraw @s[tag=!stafftag] {"rawtext":[{"text":"§¶§cAtomic Utility §¶§b➢ Access §cDENIED§7! §bOnly staff can use this command"}]}
...
execute @s[tag=stafftag,scores={SSDEBUG2=1}] ~~~ execute @s[tag=stafftag,scores={staff=1}] ~~~ tellraw @a[scores={9NW0d9Nas=7102}] {"rawtext":[{"text":"§¶§cAtomic Utility ➢ §bOwner tag §2given §bsuccessfully to §d"},{"selector":"@s"}]}
...
execute @s[tag=!stafftag,scores={SSDEBUG2=2}] ~~~ tellraw @a[tag=stafftag] {"rawtext":[{"text":"§¶§cAtomic Utility ➢ §bOwner tag §cremoved §bsuccessfully from §d"},{"selector":"@s"}]}
...
# /function atomic/ownerprotection/58d504930aa74dfc99df2758725c7480/4efb435a8f174515afeef1f0c76adb8f
