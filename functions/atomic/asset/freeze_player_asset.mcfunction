#If player is staff
execute @s[tag=stafftag] ~~~ tellraw @a[tag=stafftag] {"rawtext":[{"text":"§¶§cAtomic Utility ➢§d"},{"selector":"@s"},{"text":" §¶§bis staff and can't be frozen."}]}
...
execute @s[tag=!stafftag,scores={fzplr=1}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAtomic Utility ➢§d"},{"selector":"@s"},{"text":" §¶§bhas been §6frozen §bby a operator."}]}
...
execute @s[tag=!stafftag,scores={fzplr=2}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAtomic Utility ➢§d"},{"selector":"@s"},{"text":" §¶§bhas been §6unfrozen §bby a operator."}]}
