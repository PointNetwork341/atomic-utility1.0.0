execute @s[tag=!PermBan] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAtomic Utility ⤤ §d"},{"selector":"@s"},{"text":" §¶§bwas §2unbanned §bby an §dOperator"}]}
execute @s[tag=PermBan] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cAtomic Utility ⤤ §d"},{"selector":"@s"},{"text":" §¶§cis Atomic Global Banned and can't be unbanned"}]}
