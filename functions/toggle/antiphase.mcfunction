...
execute @s[tag=stafftag,scores={APM=1}] ~~~ tellraw @a[tag=stafftag] {"rawtext":[{"text":"§¶§cAtomic Utility §¶§b➢ §6Anti-Phase §bhas been toggled §2ON §bby §d"},{"selector":"@s"}]}
#turn off
...
execute @s[tag=stafftag,scores={APM=2}] ~~~ tellraw @a[tag=stafftag] {"rawtext":[{"text":"§¶§cAtomic Utility §¶§b➢ §6Anti-Phase §bhas been toggled §cOFF §bby §d"},{"selector":"@s"}]}
